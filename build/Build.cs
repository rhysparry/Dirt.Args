...
class Build : NukeBuild
{
    ...
    [Parameter("Version to use")]
    readonly string Version = "0.0.0";

    [Parameter("GitHub Ref")]
    readonly string GithubRef = "undefined";
    ...
    [Secret, Parameter("NuGet API key")]
            ...
            clean
                ...
                .Executes(() =>
                {
                    DotNetTasks.DotNetClean(s =>
                        s.SetProject(Solution).SetConfiguration(Configuration)
                    );
    ...
    Target Pack =>
        pack =>
            pack.WhenSkipped(DependencyBehavior.Skip)
                .DependsOn(Test)
                .Executes(() =>
                {
                    DotNetTasks.DotNetPack(s =>
                        s.SetProject(Solution.Dirt_Args)
                            .SetConfiguration(Configuration)
                            .SetVersion(BuildVersion)
